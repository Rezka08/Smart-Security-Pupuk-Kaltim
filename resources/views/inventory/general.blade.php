...
@section('title', 'Cek Inventaris General')
    ...
    <div class="col-md-10 mx-auto">
        <div class="card">
            <div class="card-header bg-info text-white">
                <h5 class="mb-0"><i class="bi bi-box-seam"></i> Pengecekan Inventaris General</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('inventory.general.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Area/Lokasi <span class="text-danger">*</span></label>
                            <input type="text" name="pos_location" class="form-control @error('pos_location') is-invalid @enderror" 
                                   value="{{ old('pos_location') }}" placeholder="Contoh: Area Pabrik" required>
                            @error('pos_location')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <h6 class="mb-3">Checklist Inventaris General</h6>
                    
                    @if($items->isEmpty())
                        <div class="alert alert-warning">
                            <i class="bi bi-exclamation-triangle"></i> Belum ada data inventaris kategori "General". 
